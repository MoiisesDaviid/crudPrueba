        ...
        <tbody>
            <tr>
                ...
                <td class="text-center">
                    <button type="button" class="btn btn-primary btn-es btn-sm">Ejecución</button>
                    <button type="button" class="btn btn-success btn-es btn-sm">Editar</button>
                    <button type="button" class="btn btn-danger btn-es btn-sm">Eliminar</button>
                </td>
            </tr>
        </tbody>
	<?php
